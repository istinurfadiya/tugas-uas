...
if (isset($_POST['request-pinjam'])) {
    ...
    $level          = $_POST['level'];
    $nama_barang    = $_POST['judulbuku'];
    $jml_barang     = $_POST['jml_barang'];
    $tgl_pinjam     = $_POST['tgl_pinjam'];
    $tgl_kembali    = $_POST['tgl_kembali'];

    $query_insert_req = mysqli_query($conn, "INSERT INTO detiltransaksi (nama_barang, peminjam, level, jml_barang, tgl_pinjam, tgl_kembali) VALUES ('$nama_barang', '$username', '$level', '$jml_barang', '$tgl_pinjam', '$tgl_kembali')");
...
<html>
<head>
    <title>Request berhasil | Peminjaman Buku Sekolah</title>
        ...
        <div class='row'>
            ...
            <div class="col-md-6 form-register-container">
                <div class="alert alert-success" style="text-transform: capitalize;">
                    Anda Berhasil mengirim permintaan peminjaman buku. Harap tunggu konfirmasi dari admin. Silahkan Cek Menu <a href="pemberitahuan.php?username=<?php echo $username; ?>">Pemberitahuan</a>
                </div>
