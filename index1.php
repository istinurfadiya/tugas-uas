...
<body>
    <div class="sidebar">
        ...
        <a href="../../anggota/data_anggota.php"><i class="fas fa-users"></i>Data Anggota</a>
        <a href="../../detailtransaksi/data_datatransaksi.php"><i class="fas fa-exchange-alt"></i>Detail Transaksi</a>
        <a href="../../penulis/data_penulis.php"><i class="fas fa-pen"></i>Data Penulis</a>
        <a href="../../penerbit/data_penerbit.php"><i class="fas fa-book"></i>Data Penerbit</a>
        <a href="../../mastertransaksi/data_master.php"><i class="fas fa-file-alt"></i>Master Transaksi</a>
        <a href="../../kategori/data_kategori.php"><i class="fas fa-layer-group"></i>Data Kategori</a>
        <a href="../../buku/data_buku.php"><i class="fas fa-book-open"></i>Data Buku</a>
