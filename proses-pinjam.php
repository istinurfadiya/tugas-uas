...
if (!empty($_GET['username']) && $_GET['username'] != "") {
    ...
    $search_barang = mysqli_query($conn, "SELECT * FROM buku WHERE id='$id_barang'");
    $data = mysqli_fetch_array($search_barang);
    $nama_barang = $data['judulbuku'];
?>
<!DOCTYPE html>
<html>
<head>
    <title>Peminjaman | Peminjaman Buku Sekolah</title>
        ...
        <div class='row'>
            ...
            <div class="col-md-4 form-register-container">
                ...
                <form action="request-barang.php" method="post">
                    ...
                    <input class="form-control" type="" name="judulbuku" required readonly value="<?php echo $data['judulbuku']; ?>">
